...
/**
 * PagesSectionItemSearch represents the model behind the search form of `common\models\PagesSectionItem`.
 */
class PagesSectionItemSearch extends PagesSectionItem
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'section_id', 'sort', 'created_at', 'updated_at'], 'integer'],
